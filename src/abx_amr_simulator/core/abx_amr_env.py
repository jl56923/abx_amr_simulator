...
class ABXAMREnv(gym.Env):
    ...
    def step(self, action):
        ...
        # Preserve pre-update visible levels to report per-step AMR deltas in info.
        previous_visible_amr_levels = self.visible_amr_levels.copy()
        ...
        delta_visible_amr_per_antibiotic = {
            abx_name: self.visible_amr_levels[abx_name] - previous_visible_amr_levels[abx_name]
            for abx_name in self.antibiotic_names
        }
